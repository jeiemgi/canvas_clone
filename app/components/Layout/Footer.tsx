    ...
    return (
        <footer className={'footer-background relative bg-black text-white'}>
            ...
            <div className={"grid-container relative"}>
                <div
                    className="col-span-2 border-opacity-20 border-white border-t border-l pl-3 pt-3 flex flex-col justify-between">
                    <div>
                ...
                <div
                    className="h-[500px] col-span-2 border-opacity-20 border-white border-t border-l pl-3 pt-3 flex flex-col justify-between">
                    <div>
                        <h3 className={'label--2 mb-5'}>DOCUMENTATION</h3>
                        <ul className={'body--3'}>
                            <li>Development</li>
                    ...
                    <div className={'label--2'}>
                        <ul>
                            <li className={'mb-4'}><a href={'#'}>©2023 Canvas LLC</a></li>
                        </ul>
                    </div>
                </div>
                <div
