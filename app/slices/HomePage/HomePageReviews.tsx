...
function HomePageReviews() {
    return (
        <div className={'select-none w-full h-screen bg-royal-blue'}>
            <div className={'grid-container relative'}>
                ...
                <div className="col-span-1 col-start-12">
                    <TextBlur verticalRight black>CONQUER</TextBlur>
                    <TextBlur verticalRight black>ROAM</TextBlur>
                </div>
                <div className="absolute bottom-0 col-span-1 col-start-1">
                    <TextBlur verticalLeft black>LEXINGTON</TextBlur>
                </div>
            </div>
        </div>
    );
